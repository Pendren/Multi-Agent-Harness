...
Follow the **test-author** skill (`.agent/skills/test-author/SKILL.md`): write tests only to **evals/acceptance/<spec-stem>/** per the task, then exit. Do not run tests or read implementation code.
