...
1. **Read your task from the path or id given in the invocation.** The Manager (or Orchestrator) will say something like: "Read your task from memory/tasks/dev-01_ST-01_scaffold-repo-layout.md" or "Your task is in memory/tasks/dev-01_ST-01_scaffold-repo-layout.md."
