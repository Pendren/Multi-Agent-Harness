...
Use this skill when you are the **Tester** and have been given a **task path** in the invocation. The task file name tells you the mode: **test-author-<id>** = write tests from spec only; **validate-<id>** = run pre-written tests only.
