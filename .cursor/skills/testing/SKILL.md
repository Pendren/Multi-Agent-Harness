...
- **Test Author:** Read task -> write tests from spec/intent/context only (no implementation) -> write to **evals/acceptance/<spec-stem>/** -> exit.
- **Test Runner:** Read task -> run pre-written tests in **evals/acceptance/<spec-stem>/** -> do not modify tests -> report pass/fail.
